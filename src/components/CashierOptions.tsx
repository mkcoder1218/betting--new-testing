                    ...
                    <div className='options-content bg-white p-6'>
                        ...
                        <Box sx={{ width: '100%' }}>
                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                <Tabs value={valueParent} onChange={handleParentTab} aria-label="tickets tab">
                                    <Tab label="Report" style={{ textTransform: "unset", color: valueParent === 0 ? "#FFFFFF" : "#000000" }} {...a11yProps(0)} />
                                    <Tab label="Event Result Search" style={{ textTransform: "unset", color: valueParent === 1 ? "#FFFFFF" : "#000000" }} {...a11yProps(1)} />
                                </Tabs>
                            </Box>
                            ...
                            <Box sx={{ borderBottom: 1, p: 0, borderColor: 'divider' }}>
                                <div className='border mt-4 border-green-500 w-full rounded-md'>
                                    <CustomTabPanel value={valueParent} index={0}>
                                        <Box sx={{ borderBottom: 1, p: 0, m: 0, borderColor: 'divider' }}>
                                            <Tabs value={value} onChange={handleChange} aria-label="tickets tab">
                                                ...
                                                <Tab label="Recall Bets" style={{ textTransform: "unset", color: value === 1 ? "#FFFFFF" : "#000000" }} {...a11yProps(1)} />
                                            </Tabs>
                                        </Box>
                                        <div className='border mt-4 border-green-500 w-full rounded-md'>
                                                            ...
                                                            {ticketList.data.map((item) => {
                                                                return <tr key={item.id} className='even:bg-gray-200 odd:bg-white text-start text-sm p-2 border-l-slate-300'>
                                                                    ...
                                                                    <td className='border border-l-slate-400 p-2'>
                                                                        {(item.nums && !item.nums.includes(-2) && !item.nums.includes(-4) && !item.nums.includes(-6)) && item?.nums}
