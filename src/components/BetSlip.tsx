        ...
        <div className='right basis-1/2 flex items-center flex-col'>
            ...
            <div className='right-slip-content w-full flex flex-col items-center p-4'>
                ...
                {betState.betSlip.length > 0 && betState.betSlip.map((item, index) => {
                    return <div key={index} className="selected-nums-con w-3/4 bg-gray-500 rounded-md p-2 mt-4 text-white">
                        ...
                        <div className="inc-dec mt-2 flex bg-white p-1 items-center justify-between flex-shrink-0">
                            ...
                            <div onClick={() => changeIndividualSlipStake(index, item.stake >= 20 ? item.stake - 10 : 10)} className='text-white hover:bg-gray-500 cursor-pointer transition-all h-6 w-6 justify-center dec bg-black rounded-md flex items-center p-1'>
                                -
                            </div>
                        </div>
                ...
                {betState.betSlip.length > 0 && <>
                    ...
                    <div className='btn-container-bet mt-2 flex gap-2 justify-stretch w-3/4 items-center'>
                        <button onClick={() => updateStakeAll(10)} className='bg-green-600 hover:opacity-75 transition-all flex-grow p-3 rounded-md text-white'>10 <span className='ml-3'>$</span> </button>
                        <button onClick={() => updateStakeAll(20)} className='bg-pink-600 hover:opacity-75 transition-all flex-grow p-3 rounded-md text-white'>20 <span className='ml-3'>$</span> </button>
                        <button onClick={() => updateStakeAll(50)} className='bg-blue-600 hover:opacity-75 transition-all flex-grow p-3 rounded-md text-white'>50 <span className='ml-3'>$</span> </button>
                        <button onClick={() => updateStakeAll(100)} className='bg-blue-400 hover:opacity-75 transition-all flex-grow p-3 rounded-md text-white'>100 <span className='ml-3'>$</span> </button>
                    </div>
