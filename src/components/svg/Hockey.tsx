...
function Hockey(Props: hokey) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 47.53 51.97"
      data-svg-id="SpeedSkatingSVG"
      className="icon w-7 text-gray-900 hover:text-green-700"
      style={{ width: Props?.isSmall ? 17 : 29, color: Props.isSmall ? "white" : "gray" }}
      src="/Images/SpeedSkatingIcon.svg"
    >
      <path
        className="svgI"
        data-name="Ice Skating"
        fill={Props.isGreen ? "rgba(15, 207, 31, 1)": Props.isWhite ? "white" : "gray"}
