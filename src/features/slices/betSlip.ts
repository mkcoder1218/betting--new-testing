...
function transformData(data) {
  ...
  data.tickets.forEach((ticket) => {
    ...
    lineItems.push({
      LineItem: ticket.game.split(' ')[0].include('Keno') || ticket.game.split(' ')[0].include("Spin") ? '    ' + ticket.selected : '    ' + ticket.selected.split(' ')[0] + '. ' + ticket.playerName + ' ' + ticket.selected.split(' ')[1],
      FontName: "Arial",
      FontSize: 8,
      Bold: false,
      Italic: false,
