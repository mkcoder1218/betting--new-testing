...
let initialState: UserState = {
    ...
    error: null,
    message: "",
    user: localStorage.getItem(LOCAL_USER) ? JSON.parse(localStorage.getItem(LOCAL_USER)!) : null
}
...
export const authUser = (username: string, password: string, navigate: NavigateFunction) => async (dispatch: (arg0: { payload: UserState; type: "user/loginUser"; }) => void) => {
